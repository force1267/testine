...
<div>
   ...
   see wocfulab.todo for security issues for admin panel(user/pass/host for mongodb) - append the woshi name at the footer
   use vue loader component to wait to load data of a page component from the back-end like youtube style using github.com/f/vue-wait
    ezapply.ir
    visamondial.com
    cds.org.ir
    ezam-daneshjoo.ir
