<template>
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6> <!-- xs12 md4 => Medium screens: use 4/12 (33%) of the screen | Anything smaller(sm): 8/12 -->
              ...
              <!-- live search like tag pagination - also show all comments for a single post in its page
              use ckeditor - use post tags in main site for better seo performance
